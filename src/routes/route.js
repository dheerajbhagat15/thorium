...
router.get('/test-me', function (req, res) {
    obj.welcome('Welcome to my application. I am Dheeraj Bhagat and a part of FunctionUp Thorium cohort' )
    today.printDate()
    today.printMonth()
    today.getBatchInfo()
    textFormatter.whiteSpaceRemover("   Dheeraj Bhagat     ")
    textFormatter.changetoLowerCase("DhEeRaj BHagaT")
    textFormatter.changetoUpperCase("Dheeraj Bhagat")
